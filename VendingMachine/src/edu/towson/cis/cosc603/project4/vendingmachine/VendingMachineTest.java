...
public class VendingMachineTest {
	...
	@Before
	public void setUp() {
		item = new VendingMachineItem(code,amount[1]);
	...
	public void testAddItem() {
		vendingMachine1.addItem(item, code);
		assertEquals(code,vendingMachine1.getItem(code).getName());
	}
	...
	public void testNullAddItem() {
		vendingMachine1.addItem(null, code);
	}
	...
	public void testRemoveItem() {
		vendingMachine1.addItem( item, code);
		vendingMachine1.removeItem(code);
		assertNull(vendingMachine1.getItem(code));
	}
	...
	public void testReturnRemoveItem() {
		vendingMachine1.addItem( item, code);
		vendingMachine1.addItem(vendingMachine1.removeItem(code), code);
		assertEquals(code,vendingMachine1.getItem(code).getName());
	}
	...
	public void testPostconditionMakePurchase() {
		vendingMachine2.makePurchase(code);
	...
	public void testReturnMakePurchase() {
		assertFalse(vendingMachine1.makePurchase(code));
		assertTrue(vendingMachine2.makePurchase(code));
		assertFalse(vendingMachine2.makePurchase(code));
		vendingMachine2.addItem(item, code);
		assertFalse(vendingMachine2.makePurchase(code));
	}
